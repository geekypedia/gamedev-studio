...
godot_export_templates(){
    ...
    TEMPLATE_FILE="$TMP_DIR/$APP_templates.tpz"
...
'
    ...
    BACKUP_TS=$(get_timestamp)
    
    BACKUP_DESTDIR="${ROFI_BACKUPDIR}.${BACKUP_TS}"
    BACKUP_DESTDIR_ROOT="${ROFI_BACKUPDIR_ROOT}.${BACKUP_TS}"
...
' '
    ...
    run_step "redot" "Redot" "is_installed redot" '
        ...
        # Install Redot icon
        REDOT_ICON_DATA="data:image/png;base64,"
